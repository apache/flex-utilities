...
import org.apache.flex.pmd.parser.Operators;
import org.apache.flex.pmd.parser.ast.Token;
import org.apache.flex.pmd.parser.exceptions.NullTokenException;
import org.apache.flex.pmd.parser.exceptions.TokenException;
import org.apache.flex.pmd.parser.exceptions.UnExpectedTokenException;
import org.apache.flex.pmd.parser.exceptions.UnExpectedTokenException.Position;
 ...
 * @author xagnetti
 */
public class AS3Parser implements Parser {
     ...
     *
     */
    public AS3Parser(ParserOptions parserOptions) {
    ...
    */
    public final IParserNode buildAst(final String filePath) throws IOException,
        ...
        return parseLines(filePath, lines.toArray(new String[lines.size()]));
    }
    ...
    */
     ...
     * @return
     */
    /*private*/ AS3Scanner getScn() {
        return scn;
    }

    /*private*/ void nextToken() throws TokenException {
        nextToken(false);
    }
     ...
     */
    private void nextToken(final boolean ignoreDocumentation) throws TokenException {
        do {
     ...
     * @throws TokenException
     */
    /*private*/ Node parseClassContent() throws TokenException {
     ...
     */
    /*private*/ Node parseCompilationUnit() throws TokenException {
     ...
     * @throws TokenException
     */
    private IParserNode parseExpression() throws TokenException {
     ...
     * @throws TokenException
     */
    /*private*/ Node parseInterfaceContent() throws TokenException {
        final Node result = Node.create(NodeKind.CONTENT,
                tok.getLine(),
                tok.getColumn());
        while (!tokIs(Operators.RIGHT_CURLY_BRACKET)) {
     ...
     * @throws UnExpectedTokenException
     */
    /*private*/ Node parsePackageContent() throws TokenException {
        final Node result = Node.create(NodeKind.CONTENT,
                tok.getLine(),
                tok.getColumn());
        final List<Token> modifiers = new ArrayList<Token>();
     ...
     * @throws TokenException
     */
    /*private*/ Node parsePrimaryExpression() throws TokenException {
     ...
     * @throws TokenException
     */
    /*private*/ IParserNode parseStatement() throws TokenException {
        IParserNode result;
     ...
     * @throws TokenException
     */
    private Node parseUnaryExpression() throws TokenException {
        Node result;
