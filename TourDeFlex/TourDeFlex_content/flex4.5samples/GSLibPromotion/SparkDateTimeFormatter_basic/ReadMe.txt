Sample Name ---- Spark DateTimeFormatter
...
For more information about flash.globalization.DateTimeFormatter, please visit: http://help.adobe.com/en_US/FlashPlatform/beta/reference/actionscript/3/flash/globalization/DateTimeFormatter.html

Usage of the sample code:
1. Select a Locale from the locale comboBox first. It will use en_US as the default choice.
2. Select a date from the date chooser.
3. The formatted date string will be shown at the bottom. 